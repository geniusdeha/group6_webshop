...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("Checking customer number. Please wait...");
        try {
            // JAVA CODE
        ...
        Customer customer = WebshopIO.readCustomer(Integer.parseInt(customerID));
        
        if(customer != null){
            ProductList list = WebshopIO.readProducts();
