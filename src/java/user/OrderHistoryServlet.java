...
public class OrderHistoryServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("Retreiving order history. Please wait...");
        try {
            // JAVA CODE
        ...
        orderhistory = WebshopIO.getOrderHistory(customerID);
        
        ServletContext sc = getServletContext();
        sc.setAttribute("orderhistory", orderhistory);
        // JAVA CODE
        RequestDispatcher disp = getServletContext().getRequestDispatcher("/orderhistory.jsp");
